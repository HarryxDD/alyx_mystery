  ...
  return (
    <div className='comm__highlight comm__padding'>
      ...
      <div className='highlight__news'>
        ...
        <News image="https://strapi.sandbox.game/uploads/0_4c021ff78a.png" category="GAME JAMS" title="The Sandbox Game Jam — “A Glitch in the Metaverse” (300,000 SAND + LANDS in Prizes)!" date="Jan 03 - 0 min read"/>
